...
let package = Package(
	...
	dependencies: [
        ...
        .package(url: "https://github.com/barimax/Perfect-Session-MySQL.git", .branch("master")),
	],
	targets: [
		.target(name: "CSServer", dependencies: ["PerfectHTTPServer", "CSCoreView", "SwiftMoment", "PerfectSMTP", "PerfectMustache", "PerfectSessionMySQL"]),
